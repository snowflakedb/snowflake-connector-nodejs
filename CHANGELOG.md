...
- Bumped (overridden) `gaxios` dependency from pinned `7.1.3` to `^7.1.4` to address transitive dep `minimatch` vulnerability CVE-2026-26996 (snowflakedb/snowflake-connector-nodejs#1331)
