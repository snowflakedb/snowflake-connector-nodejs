...
- Bumped axios to `1.15.0` to address deprecated `url.parse()` warning in Node.js 22+ ([axios/axios#10625](https://github.com/axios/axios/pull/10625)) (snowflakedb/snowflake-connector-nodejs#1386)
