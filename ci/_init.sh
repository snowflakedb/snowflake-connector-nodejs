...
declare -A BUILD_IMAGE_NAMES=(
    # TODO: upgrade this chainguard build image to the latest Node LTS
...
declare -A TEST_IMAGE_NAMES=(
    # TODO: upgrade these chainguard test images to the latest Node LTS
...
declare -A BASE_IMAGES=(
    # TODO: upgrade these chainguard base images to the latest Node LTS
