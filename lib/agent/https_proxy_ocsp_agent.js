...
function HttpsProxyAgent(opts)
{
  ...
  console.log("debugMsg proxProtocol: " + proxy.protocol);
  ...
  console.log("debugMsg proxyUser: " + proxy.user);
...
function connect(req, opts, fn)
{
  ...
  if (this.secureProxy)
  {
    console.log("debugMsg tls.connect");
    socket = tls.connect(proxy);
  }
  else
  {
    console.log("debugMsg net.connect");
