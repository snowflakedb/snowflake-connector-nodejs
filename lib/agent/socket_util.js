...
function isOcspValidationDisabled(host) {
  ...
  console.log('GlobalConfig.isOCSPChecksDisabled()', GlobalConfig.isOCSPChecksDisabled());
  console.log('Parameters.getValue(Parameters.names.JS_DRIVER_DISABLE_OCSP_FOR_NON_SF_ENDPOINTS)', Parameters.getValue(Parameters.names.JS_DRIVER_DISABLE_OCSP_FOR_NON_SF_ENDPOINTS));
  console.log('REGEX_SNOWFLAKE_ENDPOINT.test(host)', REGEX_SNOWFLAKE_ENDPOINT.test(host));
  return (
