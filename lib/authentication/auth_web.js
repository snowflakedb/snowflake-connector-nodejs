 ...
 * @constructor
 */
function auth_web(connectionConfig)
{

  var host = util.construct_hostname(connectionConfig.region, connectionConfig.account);
  var port = HTTPS_PORT;
  ...
  this.authenticate = function ()
  {
    return new Promise(async (resolve) =>
    {
      ...
      var ssoURL = await getSSOURL(connectionConfig.getAuthenticator(),
