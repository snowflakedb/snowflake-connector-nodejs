...
function throwErrorIfAuthenticatorNotAllowed(connectionConfig) {
  if (!connectionConfig.getEnableExperimentalAuthentication() &&
    [AuthenticationTypes.PROGRAMMATIC_ACCESS_TOKEN].includes(connectionConfig.getAuthenticator())
  ) {
...
exports.getAuthenticator = function getAuthenticator(connectionConfig, httpClient) {
  throwErrorIfAuthenticatorNotAllowed(connectionConfig);
