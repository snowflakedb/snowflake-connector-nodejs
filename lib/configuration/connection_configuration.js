...
function readTokenFromFile(fixedConfiguration) {
  // Accept both the snake_case form (raw connections.toml / programmatic options)
  // and the camelCase form produced by normalizeConnectionOptions.
  const tokenFilePath =
    fixedConfiguration.token_file_path ||
    fixedConfiguration.tokenFilePath ||
