...
function Connection(context)
{
  ...
  this._queryContextCacheSize = connectionConfig.queryContextCacheSize||5;
  if(!connectionConfig.disableQueryContextCache){
    this.qcc = new QueryContextCache(this._queryContextCacheSize);
  }
  ...
  */
  ...
  this.getQueryContextCacheSize = function() {
    return this._queryContextCacheSize;
  }

  this.setQueryContextCacheSize = function(size) {
    return this._queryContextCacheSize = size;
  }

  this.getQueryContext = function () {
    if(this.connectionConfig.disableQueryContextCache){
      return;
    }
    return this.qcc.serializeQueryContext();
  }

  this.setQueryContext = function (data) {
    if(this.connectionConfig.disableQueryContextCache){
      this.qcc.deserializeQueryContext(data);
    }
  }

  this.initializeQueryContextCache = function() {
    this.qcc = new QueryContextCache(this._queryContextCacheSize);
  }
  ...
  */
  ...
  this.connect = function (callback)
  {
    ...
    if(!this.disableQueryContextCache){
      this.initializeQueryContextCache()
    }
