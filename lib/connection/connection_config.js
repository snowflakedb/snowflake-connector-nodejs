...
function consolidateHostAndAccount(options) {
  ...
  if (Util.exists(options.region)) {
    Logger.default().info('Deprecated usage: Please append a region or subdomain to the end of the account parameter, e.g., account=<account>.<region>.snowflakecomputing.com"');
