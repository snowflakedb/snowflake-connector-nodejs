...
function ConnectionConfig(options, validateCredentials, qaMode, clientInfo) {
  ...
  const enableSingleUseRefreshTokens = options.enableSingleUseRefreshTokens;
  ...
  /**
   * Returns whether single use refresh tokens are enabled.
   *
   * @returns {Boolean}
   */
  this.getEnableSingleUseRefreshTokens = function () {
    return enableSingleUseRefreshTokens || false;
  };
