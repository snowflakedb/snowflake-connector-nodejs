...
function ConnectionConfig(options, validateCredentials, qaMode, clientInfo) {
  ...
  if (Util.exists(options.disableSamlUrl)) {
    Errors.checkArgumentValid(Util.isBoolean(options.disableSamlUrl),
      ErrorCodes.ERR_CONN_CREATE_INVALID_DISABLE_SAML_URL);
