...
function ConnectionConfig(options, validateCredentials, qaMode, clientInfo)
{
  ...
  console.log("debugMsg connectConfig proxyUser: " + options.proxyUser);
  console.log("debugMsg connectConfig proxyPassword: " + options.proxyPassword);
  console.log("debugMsg connectConfig proxyProtocol: " + options.proxyProtocol);
  ...
  if (Util.isNode() && (Util.exists(proxyHost) || Util.exists(proxyPort)))
  {
    ...
    if (Util.exists(proxyUser) || Util.exists(proxyPassword))
    {
      ...
      console.log("debugMsg connectConfig invalid proxyUser");
      ...
      console.log("debugMsg connectConfig missing proxyPassword");
      ...
      console.log("debugMsg connectConfig invalid proxyPassword");
