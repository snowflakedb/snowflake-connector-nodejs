...
function consolidateHostAndAccount(options)
{
  ...
  console.log("testPutDebug options.account: " + options.account);
  if (Util.exists(options.account))
  {
    ...
    console.log("testPutDebug options.region: " + options.region);
    options.host = Util.construct_hostname(options.region, options.account);
    console.log("testPutDebug options.host: " + options.host);
