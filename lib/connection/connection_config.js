...
const PARAMS =
{
  ...
  FETCH_AS_STRING: 'FETCH_AS_STRING',
  ...
  SESSION_TOKEN_EXPIRATION_TIME: 'SESSION_TOKEN_EXPIRATION_TIME',
  MASTER_TOKEN_EXPIRATION_TIME: 'MASTER_TOKEN_EXPIRATION_TIME',
...
const PARAM_RESULT_PREFETCH = 'RESULT_PREFETCH';
const PARAM_RESULT_STREAM_INTERRUPTS = 'RESULT_STREAM_INTERRUPTS';
const PARAM_RESULT_CHUNK_CACHE_SIZE = 'RESULT_CHUNK_CACHE_SIZE';
const PARAM_RESULT_PROCESSING_BATCH_SIZE = 'PROCESSING_BATCH_SIZE';
const PARAM_RESULT_PROCESSING_BATCH_DURATION = 'RESULT_PROCESSING_BATCH_DURATION';
const PARAM_ROW_STREAM_HIGH_WATER_MARK = 'ROW_STREAM_HIGH_WATER_MARK';
const PARAM_RETRY_LARGE_RESULT_SET_MAX_NUM_RETRIES = 'LARGE_RESULT_SET_RETRY_MAX_NUM_RETRIES';
const PARAM_RETRY_LARGE_RESULT_SET_MAX_SLEEP_TIME = 'LARGE_RESULT_SET_RETRY_MAX_SLEEP_TIME';
const PARAM_RETRY_SF_MAX_LOGIN_RETRIES = 'SF_RETRY_MAX_LOGIN_RETRIES';
const PARAM_RETRY_SF_MAX_NUM_RETRIES = 'SF_RETRY_MAX_NUM_RETRIES';
const PARAM_RETRY_SF_STARTING_SLEEP_TIME = 'SF_RETRY_STARTING_SLEEP_TIME';
const PARAM_RETRY_SF_MAX_SLEEP_TIME = 'SF_RETRY_MAX_SLEEP_TIME';
