...
function ConnectionConfig(options, validateCredentials, qaMode, clientInfo) {
  ...
  const oauthEnableSingleUseRefreshTokens = options.oauthEnableSingleUseRefreshTokens;
  ...
  this.oauthEnableSingleUseRefreshTokens = options.oauthEnableSingleUseRefreshTokens ?? false;
