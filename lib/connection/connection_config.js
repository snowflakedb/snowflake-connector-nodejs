...
function ConnectionConfig(options, validateCredentials, qaMode, clientInfo) {
  ...
  this.certRevocationCheckMode = options.certRevocationCheckMode ?? false;
  this.crlAllowCertificatesWithoutCrlURL = options.crlAllowCertificatesWithoutCrlURL ?? true;
  this.crlInMemoryCache = options.crlInMemoryCache ?? true;
  this.crlOnDiskCache = options.crlOnDiskCache ?? true;
  this.crlDownloadTimeoutMs = options.crlDownloadTimeoutMs ?? 10000;
