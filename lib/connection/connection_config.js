...
function ConnectionConfig(options, validateCredentials, qaMode, clientInfo)
{
  ...
  var validateDefaultParameters = options.validateDefaultParameters;
  if (Util.exists(validateDefaultParameters))
  {
    Errors.checkArgumentValid(Util.isBoolean(validateDefaultParameters),
        Errors.ERR_CONN_CREATE_INVALID_DEFAULT_PARAMETER);
  }
