...
/**
 * Returns true if this chunk's rows can be discarded and loaded again.
 *
 * @returns {Boolean}
 */
Chunk.prototype.isRowsetDiscardable = function () {
  return Util.string.isNotNullOrEmpty(this._url);
};
...
Chunk.prototype.clearRows = function (force) {
  if (this.isRowsetDiscardable() || force) {
...
Chunk.prototype.isLoaded = function () {
  ...
  return (
    Util.string.isNotNullOrEmpty(this._rowsetAsString) ||
