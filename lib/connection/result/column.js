...
function mapStructuredTypeFieldValue(columnValue, columnMetadata, context, column) {
  ...
  case 'timestamp_ltz':
    ...
    value = convertDateTimeString(columnValue, context.format, context.statementParameters['TIMEZONE'], column.getScale()).toSfDate();
    break;
  case 'timestamp_ntz':
    ...
    value = convertDateTimeString(columnValue, context.format, moment.tz.zone('UTC'), column.getScale()).toSfDate();
    break;
  case 'timestamp_tz':
  ...
  case 'time':
    ...
    value = convertDateTimeString(columnValue, context.format, context.statementParameters['TIMEZONE'], column.getScale()).toSfTime();
    break;
  case 'binary':
