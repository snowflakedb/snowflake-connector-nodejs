 ...
 * @constructor
 */
function Column(options, index, statementParameters, resultVersion, connectionConfig) {
  ...
  if (this.isNumber()) {
    ...
    if (this.isBoolean()) {
      ...
      convert = connectionConfig.returnVariantAs === 'string' ? noop : convertRawVariant;
      toString =
        connectionConfig.returnVariantAs === 'string' ? toStringFromString : toStringFromRawValue;
