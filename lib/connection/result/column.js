...
function mapStructuredTypeFieldValue(columnValue, columnMetadata, context, column) {
  ...
  case 'boolean':
    ...
    break;
  case 'timestamp_ltz':
    Logger.getInstance().info(`TIMESTAMP_LTZ_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_LTZ_OUTPUT_FORMAT']}`);
    Logger.getInstance().info(`TIMESTAMP_LTZ_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_LTZ_OUTPUT_FORMAT']}`);
    Logger.getInstance().info(`TIMESTAMP_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_OUTPUT_FORMAT']}`);
    Logger.getInstance().info(`TIMESTAMP_LTZ_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_LTZ_OUTPUT_FORMAT']}`);
    Logger.getInstance().info(`TIMESTAMP_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_OUTPUT_FORMAT']}`);
    ...
    break;
  case 'timestamp_ntz':
    Logger.getInstance().info(`TIMESTAMP_NTZ_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_NTZ_OUTPUT_FORMAT']}`);
    Logger.getInstance().info(`TIMESTAMP_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_OUTPUT_FORMAT']}`);
    ...
    break;
  case 'timestamp_tz':
    Logger.getInstance().info(`TIMESTAMP_TZ_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_OUTPUT_FORMAT']}`);
    Logger.getInstance().info(`TIMESTAMP_TZ_OUTPUT_FORMAT : ${context.statementParameters['TIMESTAMP_OUTPUT_FORMAT']}`);
