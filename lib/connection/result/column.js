 ...
 */
function noop(value) {
  return DataTypes.getIsFetchNullByFetchAsString() ? (value !== null ? value : DataTypes.getNullValue()) : value;
}
...
function toValueFromNumber(columnValue) {
  return columnValue ? columnValue.processed : ((columnValue === null && DataTypes.getIsFetchNullByFetchAsString()) ? DataTypes.getNullValue() : columnValue );
}
