...
let nullValue = null;
let isFetchNullByFetchAsString = false;

exports.setIsFetchNullByFetchAsString = function (bool) {
  isFetchNullByFetchAsString = bool;
};

exports.getIsFetchNullByFetchAsString = function () {
  return isFetchNullByFetchAsString;
};

exports.setNullValue = function (isString) {
  isString ? nullValue = 'NULL' : nullValue = null;
};

exports.getNullValue = function () {
  return isFetchNullByFetchAsString ? nullValue : 'NULL';
};
