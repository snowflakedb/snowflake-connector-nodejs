/**
 * The map of symbols for datetime representation in Snowflake and in dayjs formatting.
...
function convertSnowflakeFormatToDateFormat(formatSql, scale) {
...
module.exports.convertSnowflakeFormatToDateFormat = convertSnowflakeFormatToDateFormat;
