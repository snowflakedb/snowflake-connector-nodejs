...
function RowStream(statement, context, options)
{
  ...
  var processRowBuffer = function processRowBuffer()
  {
    ...
    {
      self.push(externalizeRow(row, columns, mapColumnIdToExtractFnName, options?.rowMode));
    });
  };
