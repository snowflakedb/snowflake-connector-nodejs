  ...
  statementOptions, context, services, connectionConfig)
{
   ...
   * @param {Object} 
   */
  context.onStatementRequestSucc = async function (options, context, services, connectionConfig) {
  ...
  context.onStatementRequestSucc(statementOptions, context, services, connectionConfig);
}
