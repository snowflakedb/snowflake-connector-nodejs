...
exports[404058] = 'Invalid oauth authorization URL. The specified value must be a valid URL starting with the http or https protocol.';
exports[404059] = 'Invalid oauth client id. The specified value must not empty string';
exports[404060] = 'Invalid oauth client secret. The specified value must not empty string';
exports[404061] = 'Invalid oauth token request URL. The specified value must be a valid URL starting with the http or https protocol.';
