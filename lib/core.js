...
function Core(options) {
  ...
  const instance = {
    ...
    configure: function (options) {
      const blockFilesystemAccess = options.blockFilesystemAccess;
      if (Util.exists(blockFilesystemAccess)) {
        Errors.checkArgumentValid(
          Util.isBoolean(blockFilesystemAccess),
          ErrorCodes.ERR_GLOBAL_CONFIGURE_INVALID_BLOCK_FILESYSTEM_ACCESS,
        );
        GlobalConfig.setBlockFilesystemAccess(blockFilesystemAccess);
      }
