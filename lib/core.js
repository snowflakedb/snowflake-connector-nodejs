...
function Core(options) {
  ...
  const createConnection = function createConnection(
    connectionOptions,
    config,
    disablePermissionCheckForTomlConfig,
  ) {
    ...
    if (connectionOptions == null) {
      ...
      try {
        connectionOptions = loadConnectionConfiguration(disablePermissionCheckForTomlConfig);
      } catch (error) {
  ...
  const instance = {
     ...
     * @returns {Object}
     */
    createConnection: function (options, disablePermissionCheckForTomlConfig = false) {
      return createConnection(options, null, disablePermissionCheckForTomlConfig);
    },
