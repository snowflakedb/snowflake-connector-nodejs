...
function Core(options) {
  ...
  let moduleHttpClient = options.httpClient;
  let moduleHttpClientClass = options.httpClientClass;
  ...
  const createConnection = function createConnection(connectionOptions, config) {
    ...
    const httpClient = moduleHttpClient ||
      new moduleHttpClientClass(connectionConfig);
  ...
  const instance =
    {
      ...
      */
      ...
      configure: function (options) {
        ...
        if (Util.exists(options.httpClient)) {
          moduleHttpClient = options.httpClient;
        }

        if (Util.exists(options.httpClientClass)) {
          moduleHttpClientClass = options.httpClientClass;
        }
