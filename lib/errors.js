...
/**
 * Creates a Certificate Revocation List (CRL) Error
 *
 * @param {String} message the error message to use when building the error.
 * @param {Object} certificate the certificate that caused the error.
 * @returns {Error}
 */
exports.createCrlError = function (certificate, message) {
