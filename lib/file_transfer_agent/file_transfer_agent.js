...
function file_transfer_agent(context)
{
  ...
  */
  this.execute = async function ()
  {
    ...
    if (stageLocationType === LOCAL_FS)
    {
      ...
      {
        fs.mkdirSync(stageInfo['location'], { mode: '777', recursive: true });
      }
    }
  ...
  */
  async function uploadOneFile(meta)
  {
    ...
    {
      console.log("testPutDebug uploadOneFile error: " + err);
  ...
  */
  ...
  {
    console.log("testPutDebug stageLocationType: " + stageLocationType);

    if (stageLocationType == LOCAL_FS)
    {
      console.log("testPutDebug using SnowflakeLocalUtil");
