...
var SnowflakeFileUtil = new (require('./file_util').FileUtil)();
var SnowflakeRemoteStorageUtil = new (require('./remote_storage_util').RemoteStorageUtil)();
...
var SnowflakeLocalUtil = new (require('./local_util').LocalUtil)();
  ...
  */
  async function uploadOneFile(meta) {
    ...
    try {
      ...
      var sha256Digest = result.digest;
...
//TODO: Create a function to renew expired client
