...
function file_transfer_agent(context) {
  ...
  var fileName;
  var fileStream = context.fileStream ? context.fileStream : null;
...
=======
  this.execute = async function () {
    if (fileStream) {
>>>>>>> 49d0e7bfc1a919334e22b6e9df75a5ff953f3beb
...
<<<<<<< HEAD
    try
    {
      ...
      {
        var result = await SnowflakeFileUtil.compressFileWithGZIP(meta['srcFilePath'], meta['tmpDir'] + meta['subDirectory']);
=======
    try {
      if (meta['requireCompress']) {
      ...
      if (fs.existsSync(root)) {
        ...
        if (dir.isDirectory()) {
          ...
          if(fileName.includes('**')) {
            filesToPut = getAllFilesInfo(root, true);
          }
...
>>>>>>> 49d0e7bfc1a919334e22b6e9df75a5ff953f3beb
            ...
            filesToPut = getAllFilesInfo(root, false);
...
>>>>>>> 49d0e7bfc1a919334e22b6e9df75a5ff953f3beb
  ...
  */
  ...
  //     fileInfo.isDirectory() ? subDirectories.push(matchingFileName) : fileInfos.push(getFileObject(matchingFileName));
  //   }
    
  //   if(includeSubDir) {
  //       for (const subDir of subDirectories) {
  //         fileInfos.push(...getAllFilesInfo(subDir, includeSubDir, dir));
  //       }
  //   }
