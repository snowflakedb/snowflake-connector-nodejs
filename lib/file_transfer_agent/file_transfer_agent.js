...
const FileUtil = require('./file_util').FileUtil;
  ...
  */
  async function uploadOneFile(meta) {
    ...
    try {
      ...
      const matchingFileNames = SnowflakeFileUtil.getMatchingFilePaths(meta['tmpDir'], meta['srcFileName'] + '*');
      ...
      if (fs.existsSync(root)) {
        ...
        if (dir.isDirectory()) {
          ...
          if (fileName.includes('*')) {
            ...
            const matchingFileNames = SnowflakeFileUtil.getMatchingFilePaths(root, fileName);
