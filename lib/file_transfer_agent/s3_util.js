    ...
    try {
      ...
      try {
        ...
        if (err['Code'] === EXPIRED_TOKEN) {
          ...
          // Record the cause so the caller can report it: without this an unrecognized
          // failure here (a TLS handshake rejection, for instance) surfaces to the user as
          // "Unknown Error in uploading a file".
          meta['lastError'] = err;
