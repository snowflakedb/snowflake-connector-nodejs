 ...
 * @param fsPromises
 * @param useSync
 * @returns {Promise<void>} resolves always to true for Windows
 */
...
exports.validateNoExtraPermissionsForOthersSync = function (filePath) {
  return exports.validateOnlyUserReadWritePermissionAndOwner(filePath, fs, true);
};
...
function shouldSkipWarningForReadPermissions() {
  return process.env.SNOWFLAKE_SKIP_WARNING_FOR_READ_PERMISSIONS !== undefined;
}
