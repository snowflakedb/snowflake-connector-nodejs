...
let credentialManager = createDefaultCredentialManager();
...
exports.setCustomCredentialManager = function (customCredentialManager) {
  ...
  Logger.getInstance().debug('Custom credential manager is set by a user.');
};
...
function createDefaultCredentialManager() {
  const JsonCrednetialManager = require('./authentication/secure_storage/json_credential_manager');
  return new JsonCrednetialManager();
};
