...
const localStorage = require('./authentication/SecureStorage/localStorage');
...
exports.tokenStorageParser = function () {

  this.read = function (host, user, authMethod) {
    return localStorage.readCredential(host, user, authMethod);
  }

  this.write = function (host, user, authMethod, credential) {
     localStorage.writeCredential(host, user, authMethod, credential);
  }
}
