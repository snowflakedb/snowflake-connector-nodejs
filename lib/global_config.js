...
let ocspState = OCSP_STATE.UNSET;
let ocspFailOpen = null;

/**
 * Sets OCSP defaults.
 */
exports._setOcspDefaults = function () {
  ocspFailOpen = null;
  ocspState = OCSP_STATE.UNSET;
};

/**
 * Updates the fail-open/fail-closed preference and enables OCSP.
 *
 * @param {boolean} value
 */
...
exports.setDisableOCSPChecks = function (value) {
  ...
  if (value) {
    ocspState = OCSP_STATE.EXPLICITLY_DISABLED;
  } else {
    ocspState = OCSP_STATE.ENABLED;
  }
};
...
exports.isOCSPChecksDisabled = function () {
  const state = getOcspModeFunc();
  return state === OCSP_STATE.EXPLICITLY_DISABLED || state === OCSP_STATE.UNSET;
};
 ...
 * @returns {string}
 */
exports.getOcspMode = getOcspModeFunc;

function getOcspModeFunc() {
  if (ocspState !== OCSP_STATE.ENABLED) {
...
function createXmlColumnVariantParser(config) {
  ...
  if (!Util.isObject(config)) {
    ...
    parserConfiguration = {
      ...
      attributesGroupName:
        config.attributesGroupName !== undefined
...
exports.setCustomCredentialManager = function (customCredentialManager) {
  Errors.checkArgumentValid(
    Util.checkValidCustomCredentialManager(customCredentialManager),
