...
exports.setDisableOCSPChecks = function (value) {
  ...
  ocspState = value ? OCSP_STATE.EXPLICITLY_DISABLED : OCSP_STATE.ENABLED;
};

/**
 * Returns whether OCSP is currently off.
 *
 * @returns {boolean}
 */
exports.isOCSPChecksDisabled = function () {
  return ocspState !== OCSP_STATE.ENABLED;
};

let ocspFailOpen = true;

/**
 * Updates the stored fail-open/fail-closed preference. Does not enable OCSP.
 *
 * @param {boolean} value
 */
...
/**
 * Stores fail-open/fail-closed and enables OCSP.
 *
 * @param {boolean} value
 */
exports.enableOcspFailOpen = function (value) {
  exports.setOcspFailOpen(value);
