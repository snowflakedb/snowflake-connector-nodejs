...
exports.setCustomCredentialManager = function (storage) {
  exports.CredentialManager = new CustomCredentialManager(storage);
}
...
function CustomCredentialManager(storage) {
  ...
  this.read = function (host, user, credType) {
    return storage.read(host, user, credType);
  }

  this.write = function (host, user, credType, credential) {
    storage.write(host, user, credType, credential);
  }

  this.remove = function (host, user, credType) {
    storage.remove(host, user, credType);
  }
}
