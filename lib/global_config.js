...
let customClientEnvironment = {};

/**
 * Updates the value of the 'customClientEnvironment' parameter.
 *
 * @param {boolean} value
 */
exports.setCustomClientEnvironment = function (value)
{
  // validate input
  Errors.assertInternal(Util.isObject(value));

  customClientEnvironment = value;
};

/**
 * Returns the value of the 'customClientEnvironment' parameter.
 *
 * @returns {boolean}
 */
exports.getCustomClientEnvironment = function ()
{
  return customClientEnvironment;
};