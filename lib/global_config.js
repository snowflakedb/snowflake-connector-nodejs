...
// The default JSON parser: try JSON.parse first, fall back to new Function for non-JSON-compliant
// values (e.g. undefined, NaN, Infinity) that Snowflake can return in VARIANT columns.
