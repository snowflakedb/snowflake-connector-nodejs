...
HttpClient.prototype.request = function (options)
{
  ...
  //   axios does not know how to unzip response without content-length and  https://github.com/axios/axios/issues/5298
  //   and google api returns such gzipped response https://github.com/apache/libcloud/issues/1544 and https://issuetracker.google.com/issues/177896087
    // 'Accept-Encoding': options.url.includes('storage.googleapis.com') ? 'gzip' : 'gzip',
  // };
  ...
  var sendRequest = async function sendRequest()
  {
    ...
    var requestOptions =
      {
        ...
        responseType: 'text', // we manually parse jsons or other structures from the server
      };
    ...
    // const httpsAgent = new httpsProxyAgent('https://127:port');
