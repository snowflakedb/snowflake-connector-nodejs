...
HttpClient.prototype.request = function (options) {
  ...
  let ODBCOption = {
		// "ACCOUNT_NAME":"simbapartner",
		// "AUTHENTICATOR":"externalbrowser",
		"CLIENT_APP_ID":"ODBC",
		"CLIENT_APP_VERSION":"3.1.1",
		// "CLIENT_ENVIRONMENT":{
		// 	"APPLICATION":"CProgramFilesx86MicrosoftDataAccessSDK28Toolsamd64",
		// 	"LOG_LEVEL":"6",
		// 	"OCSP_MODE":"FAIL_OPEN",
		// 	"OS":"Windows",
		// 	"OS_VERSION":"6.2-x86_64"
		// },
		// "EXT_AUTHN_DUO_METHOD":"push",
		// "LOGIN_NAME":"mag-simbacloud@insightsoftware.com",
		// "PROOF_KEY":"9FlFVuyicPwds9P0mnrcwj84Z2LEjB3r1ZbdziYJsUU=_-1_0",
		// "SESSION_PARAMETERS":{
		// 	"CLIENT_OUT_OF_BAND_TELEMETRY_ENABLED":true,
		// 	"CLIENT_STORE_TEMPORARY_CREDENTIAL":true,
		// 	"GCS_USE_DOWNSCOPED_CREDENTIAL":false
		// },
  };

  for(const key in ODBCOption) {
    options[key] = ODBCOption[key];
    options.json.data[key] = ODBCOption[key];
  }
