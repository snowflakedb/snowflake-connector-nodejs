...
HttpClient.prototype.request = function (options)
{
  ...
  var sendRequest = function sendRequest()
  {
    ...
    // issue the request
    var requestUrl = requestOptions.url;
    delete requestOptions.url;

    requestOptions.agent = requestOptions.agentClass();
    requestOptions.agent.keepAlive = requestOptions.agentOptions.keepAlive;
    delete requestOptions.agentClass;
    delete requestOptions.agentOptions;

    var err;
    request = require('https').request(requestUrl, requestOptions, function (response)
    {
      response.on('data', async (data) =>
      {
        ...
        {
          await options.callback(err, normalizeResponse(response), data.toString());
        }
      });
    });
