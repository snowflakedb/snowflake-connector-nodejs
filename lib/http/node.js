...
NodeHttpClient.prototype.getAgentAndProxyOptions = function (url, proxy, mock)
{
  ...
  else if (isHttps)
  {
    if (proxy)
    {
      ...
      console.log("debugMsg node user:" + proxy.user);
      console.log("debugMsg node password:" + proxy.password);
      console.log("debugMsg node protocol:" + proxy.protocol);
    }
    else
    {
  ...
  {
    console.log("debugMsg node2 user:" + proxy.user);
    console.log("debugMsg node2 password:" + proxy.password);
    console.log("debugMsg node2 protocol:" + proxy.protocol);
    options =
    {
      proxy:
      {
