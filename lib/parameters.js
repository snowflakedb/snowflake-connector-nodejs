...
names.VALIDATE_DEFAULT_PARAMETERS = 'VALIDATE_DEFAULT_PARAMETERS';
...
var parameters =
  [
    ...
    new Parameter(
        {
            name: names.VALIDATE_DEFAULT_PARAMETERS,
            value: false,
            desc : 'When true, validate given database, schema and warehouse '
        }
    ),
