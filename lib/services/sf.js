          ...
          else
          {
            ...
            if (body && !body.success)
            {
              ...
              if(body.code === '390195' && data.authnMethod === 'TOKEN') {
                ...
                await CredentialManager.deleteCredential(connectionConfig.account, connectionConfig.username, authenticationTypes.ID_TOKEN_AUTHENTICATOR);
    ...
    if (!err)
    {
      ...
      if (connectionConfig.getClientStoreTemporaryCredential()) {
        if(body.data.idToken){
          CredentialManager.writeCredential(connectionConfig.account, body.data.displayUserName, 
