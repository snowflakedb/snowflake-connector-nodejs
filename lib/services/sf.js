...
function SnowflakeService(connectionConfig, httpClient, config)
{
  ...
  {
    return Parameters.getValue(Parameters.names.QUERY_TAG);
  };
...
StateConnecting.prototype.continue = function (options)
{
  ...
  if (Util.exists(this.connectionConfig.getQueryTag()))
  {
    sessionParameters.SESSION_PARAMETERS.QUERY_TAG =
      this.connectionConfig.getQueryTag();
  }
