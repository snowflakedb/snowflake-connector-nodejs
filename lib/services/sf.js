...
function SnowflakeService(connectionConfig, httpClient, config)
{
  ...
  this.getValidateDefaultParameters = function()
  {
    return Parameters.getValue(Parameters.names.VALIDATE_DEFAULT_PARAMETERS);
  };
...
StateConnecting.prototype.continue = function (options)
{
  ...
  if (Util.exists(this.connectionConfig.getValidateDefaultParameters()))
  {
    sessionParameters.SESSION_PARAMETERS.CLIENT_VALIDATE_DEFAULT_PARAMETERS =
        this.connectionConfig.getValidateDefaultParameters();
