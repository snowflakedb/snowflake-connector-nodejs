    ...
    const realRequestOptions =
      {
        ...
        callback: async function (err, response, body) {
          ...
          if (err) {
            Logger.getInstance().debug(` CALLBACK ERROR${JSON.stringify(err)}`);
            // Logger.getInstance().debug(JSON.stringify(response));
            // Logger.getInstance().debug(JSON.stringify(body));
            ...
            Logger.getInstance().debug(' CALLBACK NO RESPONSE ');
            ...
            Logger.getInstance().debug(` RESPONSE STATUS ${response.statusCode}`);
            ...
            Logger.getInstance().debug(` RESPONSE WITH JSON ${JSON.stringify(body)}`);
