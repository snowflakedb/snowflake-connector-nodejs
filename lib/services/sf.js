...
function SnowflakeService(connectionConfig, httpClient, config)
{
  ...
  if(!connectionConfig.disableQueryContextCache){
    this.qcc = new QueryContextCache(connectionConfig.queryContextCacheSize);
  }
  ...
  */
  ...
  {
    return Parameters.getValue(Parameters.names.QUERY_CONTEXT_CACHE_SIZE);
  };
...
StateConnecting.prototype.continue = function ()
{
  ...
  if (Util.exists(this.connectionConfig.getQueryContextCacheSize()))
  {
    sessionParameters.SESSION_PARAMETERS.QUERY_CONTEXT_CACHE_SIZE =
      this.connectionConfig.queryContextCacheSize;
  }
