...
exports.checkValidCustomCrednetialManager = function (customCredentialManager) {
  ...
  for( const method of requireMethods) {
    if (!customCredentialManager.hasOwnProperty(method) || typeof customCredentialManager[method] !== 'function') {
      return false
    }
  }
  return true;
