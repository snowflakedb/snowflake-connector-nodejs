...
const snowflakeAuthTestOauthOktaClientId =
  process.env.SNOWFLAKE_AUTH_TEST_EXTERNAL_OAUTH_OKTA_CLIENT_ID;
const snowflakeAuthTestOauthOktaPassword =
  process.env.SNOWFLAKE_AUTH_TEST_EXTERNAL_OAUTH_OKTA_USER_PASSWORD;
const snowflakeAuthTestOauthOktaClientSecret =
  process.env.SNOWFLAKE_AUTH_TEST_EXTERNAL_OAUTH_OKTA_CLIENT_SECRET;
const snowflakeAuthTestOauthOktaClientToken =
  process.env.SNOWFLAKE_AUTH_TEST_EXTERNAL_OAUTH_OKTA_TOKEN;
const snowflakeAuthTestOauthOktaRedirectUri =
  process.env.SNOWFLAKE_AUTH_TEST_EXTERNAL_OAUTH_OKTA_REDIRECT_URI;
const snowflakeAuthTestOauthOktaAuthUrl =
  process.env.SNOWFLAKE_AUTH_TEST_EXTERNAL_OAUTH_OKTA_AUTH_URL;
const snowflakeAuthTestSnowflakeUser = process.env.SNOWFLAKE_AUTH_TEST_SNOWFLAKE_USER;
const snowflakeAuthTestSnowflakeInternalRole =
  process.env.SNOWFLAKE_AUTH_TEST_INTERNAL_OAUTH_SNOWFLAKE_ROLE;
const snowflakeAuthTestSnowflakeRedirectUri =
  process.env.SNOWFLAKE_AUTH_TEST_INTERNAL_OAUTH_SNOWFLAKE_REDIRECT_URI;
const snowflakeAuthTestSnowflakeClientSecret =
  process.env.SNOWFLAKE_AUTH_TEST_INTERNAL_OAUTH_SNOWFLAKE_CLIENT_SECRET;
const snowflakeAuthTestSnowflakeClientId =
  process.env.SNOWFLAKE_AUTH_TEST_INTERNAL_OAUTH_SNOWFLAKE_CLIENT_ID;
const snowflakeAuthTestSnowflakeWildcardsClientId =
...
exports.snowflakeAuthTestEncryptedPrivateKeyPath = snowflakeAuthTestEncryptedPrivateKeyPath;
exports.snowflakeAuthTestPrivateKeyPassword = snowflakeAuthTestPrivateKeyPassword;
