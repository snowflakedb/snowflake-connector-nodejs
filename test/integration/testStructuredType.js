...
describe('Test Structured types', function () {
  ...
  describe('test object', function () {
    ...
    it('test date', function (done) {
      const selectObject =
        'select {' + "'date': to_date('2023-12-24')::DATE" + '}' + '::OBJECT(date DATE) AS RESULT';
    ...
    it('test time', function (done) {
      const selectObject =
        'select {' + "'time': '09:45:45'::TIME" + '}' + '::OBJECT(time TIME) AS RESULT';
    ...
    it('test object all types fetch as string', function (done) {
      ...
      const expected = {
        RESULT:
          '{"string":"a","b":1,"s":2,"i":3,"l":4,"f":1.1,"d":2.2,"bool":true,"timestampltz":"2021-12-22 09:43:44.000 -0800","timestampntz":"2021-12-23 09:44:44.000","timestamptz":"2021-12-24 09:45:45.000 -0800","date":"2023-12-24","time":"12:34:56","binary":[97,98,99]}',
      };
    ...
    it('test nested object', function (done) {
      const selectObject =
        "select {'inside': {'string':'a', 'int':'2', 'timestamp': '2021-12-22 09:43:44'::TIMESTAMP_LTZ}}" +
        '::OBJECT(inside OBJECT(string VARCHAR, int INTEGER, timestamp TIMESTAMP_LTZ)) as result';
      const expected = {
        RESULT: { inside: { string: 'a', int: 2, timestamp: '2021-12-22 09:43:44.000 -0800' } },
      };
      async.series(
        [
          function (callback) {
    ...
    it('test nested object - deeper hierarchy', function (done) {
      const selectObject =
        "select {'inside': {'string2':'level2', 'inside2': {'string3':'a', 'int':'2', 'timestamp': '2021-12-22 09:43:44'::TIMESTAMP_LTZ}}}" +
  ...
  describe('test array', function () {
    it('test array of varchar', function (done) {
      const selectObject =
        "SELECT ARRAY_CONSTRUCT('one', 'two', 'three')::ARRAY(VARCHAR) AS RESULT";
    ...
    it('test array of timestampLtz', function (done) {
      const selectObject =
        "SELECT ARRAY_CONSTRUCT('2021-12-22 09:43:44.123456', '2021-12-22 09:43:45.123456')::ARRAY(TIMESTAMP_LTZ) AS kaka";
    ...
    it('test array of timestampNtz', function (done) {
      const selectObject =
        "SELECT ARRAY_CONSTRUCT('2021-12-22 09:43:44', '2021-12-22 09:43:45')::ARRAY(TIMESTAMP_NTZ) AS result";
  ...
  describe('test map', function () {
      ...
      async.series(
        [
          function (callback) {
            ...
            testUtil.executeQueryAndVerify(connection, selectObject, [{ RESULT: map }], callback);
          },
        ],
        done,
      );
    ...
    it('test map of timestampLtz', function (done) {
      const selectObject =
        "SELECT { '1':'2021-12-22 09:43:44.123456', '2':'2021-12-22 09:43:45.123456'}::MAP(INTEGER, TIMESTAMP_LTZ) AS result";
    ...
    it('test map of timestampNtz', function (done) {
      const selectObject =
        "SELECT { '1':'2021-12-22 09:43:44', '2':'2021-12-22 09:43:45'}::MAP(INTEGER, TIMESTAMP_NTZ) AS result";
  ...
  describe('test nested structures', function () {
    it('test array of objects', function (done) {
      const selectObject =
        "SELECT ARRAY_CONSTRUCT({'string':'a', 'int':'1', 'timestamp': '2021-12-22 09:43:44'::TIMESTAMP_LTZ}," +
      ...
      const expected = [
        { string: 'a', int: 1, timestamp: '2021-12-22 09:43:44.000 -0800' },
    ...
    it('test array of arrays', function (done) {
      const selectObject =
        "SELECT ARRAY_CONSTRUCT(ARRAY_CONSTRUCT('one', 'two', 'three'), " +
    ...
    it('test array of maps', function (done) {
      const selectObject =
        "SELECT ARRAY_CONSTRUCT({'x':'one', 'y':'two'}, " +
        "{'x':'one', 'y':'two'}) " +
    ...
    it('test map of objects', function (done) {
      const selectObject =
        "SELECT {'x': {'string':'a', 'int':'1', 'timestamp': '2021-12-22 09:43:44'::TIMESTAMP_LTZ}," +
    ...
    it('test map of arrays', function (done) {
      const selectObject =
        "SELECT {'x': ARRAY_CONSTRUCT('one', 'two', 'three'), " +
