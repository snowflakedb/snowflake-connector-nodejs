    ...
    it('insert, update, delete', function (done) {
      async.series(
        [
          ...
          function (callback) {
            const sqlText = 'insert into foo2 values' + ' (1,5)' + ',(2,5)' + ',(3,5)' + ',(1,5)';
            connection.execute({
              sqlText: sqlText,
              complete: function (err, statement) {
          ...
          function (callback) {
            const sqlText = 'update foo set c2 = c4 from foo2 where foo.c1 = foo2.c3;';
            connection.execute({
              sqlText: sqlText,
              complete: function (err, statement) {
    ...
    it('merge', function (done) {
      async.series(
        [
          ...
          function (callback) {
            const sqlText =
              'merge into foo using bar on foo.k = bar.k ' +
