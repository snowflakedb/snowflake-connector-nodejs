...
describe('ConnectionConfig: basic', function () {
  ...
  const testCases = [
    ...
    },
    {
      ...
      options: {
        ...
        oauthAuthorizationUrl: (config) =>
          config.getOauthAuthorizationUrl() === 'https://oauth.authorization.url',
      },
    },
    {
      ...
      options: {
        ...
        oauthAuthorizationUrl: (config) =>
          ...
          'http://host.snowflakecomputing.com:8082/oauth/authorize',
        oauthTokenRequestUrl: (config) =>
          config.getOauthTokenRequestUrl() ===
          'http://host.snowflakecomputing.com:8082/oauth/token-request',
      },
    },
    {
      name: 'oauth public client parameters',
      ...
      options: {
        ...
        oauthAuthorizationUrl: (config) =>
          config.getOauthAuthorizationUrl() ===
          'http://host.snowflakecomputing.cn:8082/oauth/authorize',
        oauthTokenRequestUrl: (config) =>
          config.getOauthTokenRequestUrl() ===
  ...
  it('custom prefetch', function () {
    ...
    assert.strictEqual(connectionConfig.getResultPrefetch(), resultPrefetchCustom);
  });
