...
describe('Result', function()
{
  ...
  {
    "data" : {
      "parameters" : [{"name":"DATE_OUTPUT_FORMAT","value":"YYYY-MM-DD"},{"name":"CLIENT_USE_V1_QUERY_API","value":true},{"name":"TIMESTAMP_LTZ_OUTPUT_FORMAT","value":""},{"name":"TIMESTAMP_NTZ_OUTPUT_FORMAT","value":""},{"name":"CLIENT_RESULT_PREFETCH_THREADS","value":1},{"name":"CLIENT_HONOR_CLIENT_TZ_FOR_TIMESTAMP_NTZ","value":true},{"name":"TIMEZONE","value":"America/Los_Angeles"},{"name":"TIMESTAMP_OUTPUT_FORMAT","value":"DY, DD MON YYYY HH24:MI:SS TZHTZM"},{"name":"TIMESTAMP_TZ_OUTPUT_FORMAT","value":""},{"name":"CLIENT_RESULT_PREFETCH_SLOTS","value":2} ],
      "rowtype" : [{"name":"C1","byteLength":null,"length":null,"type":"fixed","nullable":false,"precision":19,"scale":0},{"name":"C2","byteLength":16777216,"length":16777216,"type":"text","nullable":false,"precision":null,"scale":null} ],
      "rowset" : [["0","046Bo"],
        ["1","CaFHJ"],
        ["2","egeN4"],
        ["3","QmNTp"],
