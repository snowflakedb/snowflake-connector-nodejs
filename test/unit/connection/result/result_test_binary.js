...
describe('Result: test binary', function () {
  it("select X'0123456789ABCDEF' as C1;", async function () {
    const response = {
      data: {
        parameters: [
  ...
  it(
    "alter session set BINARY_OUTPUT_FORMAT='BASE64';" + "select X'0123456789ABCDEF' as C1;",
    async function () {
      const response = {
        data: {
          parameters: [
