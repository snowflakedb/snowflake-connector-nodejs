...
describe('Result: test boolean', function()
{
  it('select true as C1, false as C2, to_boolean(null) as C3;', function(done)
  {
    ...
    {
      "data" : {
        "parameters" : [{"name":"TIMEZONE","value":"America/Los_Angeles"},{"name":"TIMESTAMP_OUTPUT_FORMAT","value":"DY, DD MON YYYY HH24:MI:SS TZHTZM"},{"name":"TIMESTAMP_NTZ_OUTPUT_FORMAT","value":""},{"name":"TIMESTAMP_LTZ_OUTPUT_FORMAT","value":""},{"name":"TIMESTAMP_TZ_OUTPUT_FORMAT","value":""},{"name":"DATE_OUTPUT_FORMAT","value":"YYYY-MM-DD"},{"name":"CLIENT_RESULT_PREFETCH_SLOTS","value":2},{"name":"CLIENT_RESULT_PREFETCH_THREADS","value":1},{"name":"CLIENT_HONOR_CLIENT_TZ_FOR_TIMESTAMP_NTZ","value":true},{"name":"CLIENT_USE_V1_QUERY_API","value":true} ],
        "rowtype" : [{"name":"C1","byteLength":null,"nullable":true,"precision":null,"scale":null,"length":null,"type":"boolean"},{"name":"C2","byteLength":null,"nullable":true,"precision":null,"scale":null,"length":null,"type":"boolean"},{"name":"C3","byteLength":null,"nullable":true,"precision":null,"scale":null,"length":null,"type":"boolean"} ],
      ...
      "'to_boolean(null) as C3;", function(done)
  {
    var response =
    {
      "data" : {
        "parameters" : [{"name":"TIMEZONE","value":"America/Los_Angeles"},{"name":"TIMESTAMP_OUTPUT_FORMAT","value":"DY, DD MON YYYY HH24:MI:SS TZHTZM"},{"name":"TIMESTAMP_NTZ_OUTPUT_FORMAT","value":""},{"name":"TIMESTAMP_LTZ_OUTPUT_FORMAT","value":""},{"name":"TIMESTAMP_TZ_OUTPUT_FORMAT","value":""},{"name":"DATE_OUTPUT_FORMAT","value":"YYYY-MM-DD"},{"name":"CLIENT_RESULT_PREFETCH_SLOTS","value":2},{"name":"CLIENT_RESULT_PREFETCH_THREADS","value":1},{"name":"CLIENT_HONOR_CLIENT_TZ_FOR_TIMESTAMP_NTZ","value":true},{"name":"CLIENT_USE_V1_QUERY_API","value":true} ],
        "rowtype" : [{"name":"C1","byteLength":null,"nullable":false,"precision":null,"scale":null,"length":null,"type":"boolean"},{"name":"C2","byteLength":null,"nullable":false,"precision":null,"scale":null,"length":null,"type":"boolean"},{"name":"C3","byteLength":null,"nullable":true,"precision":null,"scale":null,"length":null,"type":"boolean"} ],
        "rowset" : [["1","0",null] ],
        "total" : 1,
        "returned" : 1,
