    ...
    function (done) {
      ...
      ResultTestCommon.testResult(
        ...
        function (row) {
          // timestamp_ltz
          assert.ok(Util.isDate(row.getColumnValue('C1')));
          assert.strictEqual(row.getColumnValueAsString('C1'), 'Thu, 21 Jan 2016 06:32:44 -0800');

          // timestamp_tz
          assert.ok(Util.isDate(row.getColumnValue('C2')));
          assert.strictEqual(row.getColumnValueAsString('C2'), 'Thu, 21 Jan 2016 06:32:44 -0800');
