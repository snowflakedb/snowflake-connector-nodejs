...
describe('LargeResultSetService', () => {
  ...
  describe('when all retries fail', () => {
    [
      {
        testName: 'should retry on 503',
        url: '/503',
        expectedErrorName: 'LargeResultSetError',
      },
      {
        testName: 'should retry on timeout',
        url: '/hang',
        expectedErrorName: 'NetworkError',
      },
  ...
  describe('when recover at last try', () => {
    ...
    [
      {
        testName: 'should recover from 503',
        url: '/eachThirdReturns200Others503',
      },
      {
        testName: 'should recover from timeout',
        url: '/eachThirdReturns200OthersHang',
      },
