...
describe('connection.connect() asynchronous errors', function()
{
  ...
  it('connect() while already connected', function(done)
  {
    ...
    [
      ...
      function(callback)
      {
        // connection.connect() should fail at this point because we're already
        // connected
        connection.connect(function(err, conn)
        {
          assert.strictEqual(conn, connection,
  ...
  it('connect() while fatally disconnected', function(done)
  {
    ...
    [
      ...
      function(callback)
      {
        // connection.connect() should fail at this point because the connection
        // has been destroyed
        connection.connect(function(err, conn)
        {
  ...
  it('statement api', function(done)
  {
    ...
    [
      ...
      function(callback)
      {
        ...
        // the sql text and request id should be the same as what was passed in
  ...
  it('statement api', function(done)
  {
    ...
    [
      ...
      function(callback)
      {
        ...
        // available (some of them will only be available if the statement succeeds)
        assert.strictEqual(statement.getColumns(), undefined);
        assert.strictEqual(statement.getNumRows(), undefined);
        assert.strictEqual(statement.getSessionState(), undefined);
      },
...
describe('connection.destroy()', function()
{
  ...
  it('destroy while disconnected', function(done)
  {
    ...
    [
      ...
      function(callback)
      {
        // connection.destroy() should fail at this point because the connection
        // has been destroyed
        connection.destroy(function(err, conn)
        {
          assert.ok(err, 'there should be an error');
...
describe('serialize connection', function()
{
  ...
  it('serialize when connected', function(done)
  {
    ...
    [
      ...
      function(callback)
      {
        // serialize the connection and then deserialize it to get a copy of the
        // original connection
